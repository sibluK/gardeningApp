...
plantCards.forEach(card => {
    const expandButton = card.querySelector('.expand-plant-button');
    const expandedText = card.querySelector('.expanded-text');
    const addPlantButton = card.querySelector('.add-plant-to-garden-button');
